...
def upgrade():
    ...
    with op.batch_alter_table('order_details', schema=None) as batch_op:
        ...
        batch_op.drop_constraint('fk_order_product_seller_id', type_='foreignkey')
    ...
    with op.batch_alter_table('reviews', schema=None) as batch_op:
        batch_op.drop_constraint('reviews_buyer_id_fkey', type_='foreignkey')
        batch_op.drop_constraint('reviews_seller_id_fkey', type_='foreignkey')
...
def downgrade():
    ...
    with op.batch_alter_table('reviews', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key('reviews_seller_id_fkey', 'users', ['seller_id'], ['id'])
        batch_op.create_foreign_key('reviews_buyer_id_fkey', 'users', ['buyer_id'], ['id'])
    ...
    with op.batch_alter_table('order_details', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key('fk_order_product_seller_id', 'users', ['seller_id'], ['id'])
        batch_op.create_foreign_key('order_details_order_id_fkey', 'orders', ['order_id'], ['id'])
